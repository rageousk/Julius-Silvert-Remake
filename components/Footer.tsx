    ...
    <footer className="site-footer">
      <div className="container footer-inner">
        ...
        <div className="footer-brand">
          <Link href="/" className="brand-link footer-brand-link" aria-label="Julius Silvert – Go to homepage">
          ...
          <p className="footer-est">Philadelphia, PA</p>
          ...
          <p className="footer-copy">
            Copyright &copy; {new Date().getFullYear()} Julius Silvert.
            <br />
            All rights reserved.
          </p>
